...
INSTALLED_APPS = [
    ...
    'vk_oauth_app.apps.VkOauthAppConfig',
    'social_django'
]
...
DATABASES = {
    'default': dj_database_url.config()  # DB config from environment
}
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'social_core.pipeline.social_auth.load_extra_data',  # It is necessary to get additional data (token)
